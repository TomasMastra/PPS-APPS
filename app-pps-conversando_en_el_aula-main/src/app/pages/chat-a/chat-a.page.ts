...
@Component({
  ...
  standalone: true,
  imports: [IonTextarea, IonText, IonItem, IonLabel, IonRow, IonCol, IonImg, IonFabButton, IonFab, IonInput, IonButton, IonButtons, IonFooter, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, ReactiveFormsModule]
})
